...
_THETA = {
  ...
  "lag_chase_x": 0.3026684324553861,
  "lag_chase_z": 0.06327459630575644,
  "lag_dz_lo": -0.015306334680778123,
  "lag_dxy_hi_cap": 0.29342158078988634,
  "lag_up": 0.20448078199959097,
  "lag_mix_boost": 15.144818650092997,
  "lag_arm_bx": 1.6595616268014313,
  "lag_behind_eps": 0.004212949916560078,
  "hot_far_soft": -0.19284898175016751
}
_base_path = Path('/mnt/openfoam/pingpong-venv/progression/_staging/20260716T041926Z_policy_evolved_ci_20260716T041925Z/policy_v230.py').resolve().parent / "policy_v230.py"
