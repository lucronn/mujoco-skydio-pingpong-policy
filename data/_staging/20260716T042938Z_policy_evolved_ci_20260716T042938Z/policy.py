...
_THETA = {
  ...
  "lag_chase_x": 0.3022645139797808,
  "lag_chase_z": 0.0608827125128754,
  "lag_dz_lo": -0.03607635336167482,
  "lag_dxy_hi_cap": 0.3289193072521252,
  "lag_up": 0.1803199230606596,
  "lag_mix_boost": 16.223964001316737,
  "lag_arm_bx": 1.8817705727086866,
  "lag_behind_eps": 0.05665338449609079,
  "hot_far_soft": -0.17350408751775936
}
_base_path = Path('/mnt/openfoam/pingpong-venv/progression/_staging/20260716T042938Z_policy_evolved_ci_20260716T042938Z/policy_v230.py').resolve().parent / "policy_v230.py"
